...
# 01_QB - importer, organiser et nettoyer la base de données et    #
# 02_QB - Ajouts de variables et recodages généraux                #
####################################################################
...
Base_A <- subset(QB, select = c(id, sexe,quartier, age, rester, anciennete, profession, activite, entreprise, revenu, diplome, attachement, pcs1_int, pcs2_int)) # A pour attachement 
